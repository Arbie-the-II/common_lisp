Here is the complete, cohesive, step-by-step guide formatted in Markdown. It uses your rock-solid `build.lisp` logic to ensure compilation never crashes, making it ready to drop straight into a `README.md` file or to use as an outline for your presentation.
